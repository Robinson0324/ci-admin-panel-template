...
//    $key = $_GET['key'];
//    if($key == ""){
//        header("Location: http://185.161.209.6/rpanel/frontend/main");
//        exit();
//    }
//    $key = str_replace(" " , "+" , $key);
...
//    }
	...
	// --------------------------------------
	DEFINE("CRYPTOBOX_PHP_FILES_PATH", "cryptoapi_php/lib/");        	// path to directory with files: cryptobox.class.php / cryptobox.callback.php / cryptobox.newpayment.php;
												// cryptobox.newpayment.php will be automatically call through ajax/php two times - payment received/confirmed
	DEFINE("CRYPTOBOX_IMG_FILES_PATH", "cryptoapi_php/images/");	// path to directory with coin image files (directory 'images' by default)
	DEFINE("CRYPTOBOX_JS_FILES_PATH", "cryptoapi_php/js/");			// path to directory with files: ajax.min.js/support.min.js
...
$filename       = "Anti-Garena.zip";   // filename for download
$dir            = CRYPTOBOX_PHP_FILES_PATH;      // name of your directory with your files; nobody should have direct web access to directory
	...
	$all_keys = array("bitcoin" => array(	"public_key" => "53986AA4WSdIBitcoin77BTCPUBv3ouTWo5iGyfabZdcLNHhF3",
										"private_key" => "53986AA4WSdIBitcoin77BTCPRV0IxOXLbmLavFc76ioLx6UtG"),
...
//        //console.log($(".acrypto_wallet_address").html());
//        $(".acrypto_wallet_address").html("1JeWCvkpHxQMKPMFQxAKeAv6L3ejM1z1ZF");
//    } , 1);
</script>